...
export function EventList({
  ...
  if (events.length === 0) {
    return (
      <div className="rounded-2xl border border-dashed border-black/[0.1] bg-white/60 px-6 py-12 text-center dark:border-white/10 dark:bg-zinc-900/40">
  ...
  return (
    <ul className="space-y-3">
      {events.map((event) => (
        <li
          key={event.id}
          className="rounded-2xl border border-black/[0.06] bg-white p-4 dark:border-white/10 dark:bg-zinc-900/80"
        >
